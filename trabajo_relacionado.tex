...
\begin{itemize}
    \item Los modelos físicos y estadísticos clásicos (Secciones 3.1 y 3.2) ofrecen transparencia matemática, rigor explicativo y garantías de aditividad, pero fracasan al intentar modelar las complejidades y no linealidades del uso de suelo moderno al depender exclusivamente de la distancia y la masa poblacional como variables \textit{proxy} de oportunidad.
