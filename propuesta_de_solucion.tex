...
El análisis de explicabilidad requiere fijar antes de su ejecución la salida, el conjunto de referencia, el modo de evaluación, la muestra, la semilla y los controles de estabilidad. Sus atribuciones describen sensibilidad predictiva de la salida declarada y no efectos causales; este capítulo no anticipa sus resultados.
