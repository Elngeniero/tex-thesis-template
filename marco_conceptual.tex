...
Simini et al. \cite{simini2012universal} propusieron en 2012 el modelo de radiación como una alternativa libre de parámetros al modelo gravitatorio, consolidándose como el baseline mecanicista indispensable. Partiendo de una analogía con los procesos de radiación y absorción en física de partículas, el modelo de radiación se fundamenta en un proceso estocástico de toma de decisiones locales: cada individuo en un origen busca la mejor oportunidad disponible dentro de radios geográficos crecientes, y se desplaza hacia el destino donde la encuentra. Este enfoque permite modelar de forma realista la asimetría y dispersión de los viajes.
