...
Los valores SHAP permiten estudiar la contribución de los atributos a una predicción con respecto a una referencia. En esta memoria, el análisis complementario incluyó aproximaciones de Shapley con referencias de entrenamiento y controles de estabilidad predefinidos. Ninguna de ellas produjo atribuciones que superaran todos los controles de publicación; por ello, el resultado se limita a la evaluación metodológica del procedimiento y no a una interpretación de la importancia de los atributos. En cualquier caso, las atribuciones se interpretan como propiedades de predicciones y no como efectos causales de intervenciones urbanas.
...
Los gradientes integrados pueden considerarse una técnica complementaria para atribuir una salida diferenciable del modelo a sus entradas. En Santiago, el control de completitud no se acreditó para toda la cobertura requerida, incluso al aumentar la cuadratura en la consulta crítica; por ello, las atribuciones de este método no se interpretan como resultados de la memoria.
