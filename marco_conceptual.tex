...
Simini et al. \cite{simini2012universal} validaron el modelo sobre datos de commuting del censo de Estados Unidos (2000). Los resultados muestran que el modelo de radiación supera al modelo gravitatorio en la reproducción de flujos observados. La mejora es particularmente marcada en viajes de corta distancia, que el modelo gravitatorio tiende a sobreestimar. A pesar de sus ventajas, el modelo de radiación utiliza exclusivamente la población como \textit{proxy} de oportunidades, sin incorporar características del tejido urbano como el uso de suelo o la distribución de actividades económicas. Esta limitación fue el punto de partida para el desarrollo de modelos basados en aprendizaje profundo.
