...
\begin{enumerate}
    ...
    \item Analizar las atribuciones predictivas de las características territoriales del modelo final estabilizado mediante técnicas de inteligencia artificial explicable (XAI), documentando la configuración y la estabilidad del análisis.
\end{enumerate}
