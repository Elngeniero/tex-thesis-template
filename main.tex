...
\newcommand{\titulo}{Modelación de flujos de transporte público en Santiago de Chile mediante Deep Gravity: sensibilidad a la discretización espacial y análisis de atribuciones predictivas}
