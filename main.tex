...
% \newcommand{\titulo}{Generacion de flujos de movilidad para Santiago de Chile con Deep Gravity: impacto de las amenities de OpenStreetMap y analisis de explicabilidad.}
\newcommand{\titulo}{Generación de flujos de movilidad en Santiago de Chile mediante Deep Gravity: evaluación del impacto de las amenities de OpenStreetMap y análisis mediante XAI}
\newcommand{\ciudad}{Santiago} % e.g. Valparaíso
% TODO: Consultar el formato de los nombres:
\newcommand{\nombrealumno}{Pablo Alberto Campos Ávila}
\newcommand{\nombreprofesor}{Daniela Opitz W}
\newcommand{\nombrecorreferente}{Nombre del correferente NN2}
