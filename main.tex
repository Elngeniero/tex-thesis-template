...
\newcommand{\titulo}{Predicción de flujos de movilidad urbana en Santiago de Chile mediante el modelo DeepGravity y variables de entorno urbano}
\newcommand{\ciudad}{Santiago} % e.g. Valparaíso
% TODO: Consultar el formato de los nombres:
\newcommand{\nombrealumno}{Pablo Alberto Campos Avila}
\newcommand{\nombreprofesor}{Daniela Opitz}
\newcommand{\nombrecorreferente}{Nombre del correferente LIUVA EN 45663333}
